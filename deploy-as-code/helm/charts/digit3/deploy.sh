...
#   ./deploy.sh -f digit3services-single-container-helmfile.yaml apply       # then services
#   ./deploy.sh -f digit3services-single-container-helmfile.yaml -l name=keycloak diff
#
