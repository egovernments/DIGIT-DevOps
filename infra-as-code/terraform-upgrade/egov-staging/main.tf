terraform {
  backend "s3" {
    ...
    dynamodb_table = "egov-staging-terraform-state"
...
module "eks" {
  ...
  iam_role_arn = "arn:aws:iam::680148267093:role/egov-staging20210618112047850400000001"
  ...
  tags = {
    ...
    "kubernetes.io/cluster/egov-staging" = "owned"
  }
}
